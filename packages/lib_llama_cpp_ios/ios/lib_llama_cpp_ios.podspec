...
prebuilt_framework = File.expand_path('Frameworks/lib_llama_cpp_ios.xcframework', File.realpath(__dir__))
...
Pod::Spec.new do |s|
  ...
  if File.exist?(prebuilt_framework)
    ...
    s.preserve_paths = 'Frameworks/lib_llama_cpp_ios.xcframework'
